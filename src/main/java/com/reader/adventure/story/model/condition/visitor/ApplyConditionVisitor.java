...
public class ApplyConditionVisitor implements IConditionVisitor {

    @Override
    public boolean visit(ConditionAgility condition, Player player) {
    ...
    @Override
    public boolean visit(ConditionGold condition, Player player) {
